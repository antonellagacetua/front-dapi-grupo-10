...
const FavoriteMovieCard = ({navigation, movieId, onFavoriteRemoved}) => {
  const [movieData, setMovieData] = useState(null);
  const {
    data,
    loading,
    error: fetchError,
  } = useFetch(`https://movieplay-back.onrender.com/pelicula/${movieId}`);
  ...
  return (
    <Pressable
      style={{width: '100%', paddingHorizontal: 25, paddingBottom: 40}}
      onPress={() => navigation.navigate('MovieScreen', {id: movieId})}>
